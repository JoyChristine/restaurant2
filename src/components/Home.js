...
const Home = () => {
    return (
       ...
       <h2>Best Dessert in Town</h2>
        ...
        Phasellus ut mi tristique, feugiat arcu vel, venenatis justo Lorem ipsum dolor sit amet, consectetur adipiscing elit.Vivamus malesuada leo eget metus pretium fermentum.Etiam ultrices, quam sed fermentum maximus, lacus ex vestibulum  </p>
        <video width ="700" height="540" controls> <source src = "" type="video/mp4"></source> 
        </video>
